...
@Database(entities = [EntitasSurah::class, EntitasAyat::class, EntitasTerjemahan::class, EntitasTafsir::class, EntitasBookmark::class, EntitasAudioCache::class, EntitasRiwayat::class], version = 2, exportSchema = false)
