...
- Build Kotlin/Compose dengan min SDK 24 dan target SDK 34.
- Navigasi Beranda, Mushaf, Audio, dan Saya.
- Kontrol tema terang/gelap.
- Tombol pindah Mushaf, Audio, Cari, Simpan, dan Tematik.
- Mushaf dengan pinch-to-zoom dan bookmark lokal sesi tampilan.
...
- Bundel data 114 surah dan terjemahan yang sudah diverifikasi lisensinya.
- Persistensi bookmark/folder/catatan dan ekspor-impor JSON/CSV.
- Implementasi Media3 service foreground dan notifikasi audio.
